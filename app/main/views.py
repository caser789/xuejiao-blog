...
def moderate():
    # show all comments in moderate pages
...
# use attribute disabled to show or hide comments which is get by id
...
# use attribute disabled to hide comments
...
# show all posts
# set show_folloed in cookies as false
@main.route('/all')
@login_required
def show_all():
    resp = make_response(redirect(url_for('.index')))
    resp.set_cookie('show_followed', '', max_age=30*24*60*60) # a mounth
    return resp
